...
export class ViewOrderItemShipmentComponent extends SharedComponent implements OnInit, OnDestroy {
    @ViewChild('this.ViewOrderItemShipmentsTable', { static: false }) viewOrderItemShipmentsTable!: TreeTable;  
    ...
    constructor(private readonly router: Router,
        ...
        readonly orderItemShipmentService: OrderItemShipmentService,
