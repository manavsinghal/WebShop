...
export class ViewShoppingCartWishListComponent extends SharedComponent implements OnInit, OnDestroy {
    @ViewChild('this.ViewShoppingCartWishListsTable', { static: false }) viewShoppingCartWishListsTable!: TreeTable;  
    ...
    constructor(private readonly router: Router,
        ...
        readonly shoppingCartWishListService: ShoppingCartWishListService,
