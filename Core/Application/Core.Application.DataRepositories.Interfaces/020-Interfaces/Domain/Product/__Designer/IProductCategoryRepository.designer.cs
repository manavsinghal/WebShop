...
public partial interface IProductRepository : COREAPPDREPOINTERFACES.IRepository
{
	...
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.GetProductCategoryResponse> GetProductCategoriesAsync(COREAPPDATAREPOMODELSDOMAIN.GetProductCategoryRequest request);
	...
	/// <param name="request">request</param>
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.MergeProductCategoryResponse> MergeProductCategoriesAsync(COREAPPDATAREPOMODELSDOMAIN.MergeProductCategoryRequest request);

	/// <summary>
	/// Save ProductCategories
	/// </summary>
	/// <returns></returns>
	Task SaveProductCategoryAsync();
