...
public partial interface ISellerRepository : COREAPPDREPOINTERFACES.IRepository
{
	...
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.GetSellerResponse> GetSellersAsync(COREAPPDATAREPOMODELSDOMAIN.GetSellerRequest request);
	...
	/// <param name="request">request</param>
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.MergeSellerResponse> MergeSellersAsync(COREAPPDATAREPOMODELSDOMAIN.MergeSellerRequest request);

	/// <summary>
	/// Save Sellers
	/// </summary>
	/// <returns></returns>
	Task SaveSellerAsync();
