...
public partial interface ISellerRepository : COREAPPDREPOINTERFACES.IRepository
{
	...
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.GetSellerBankAccountResponse> GetSellerBankAccountsAsync(COREAPPDATAREPOMODELSDOMAIN.GetSellerBankAccountRequest request);
	...
	/// <param name="request">request</param>
	/// <returns></returns>
	Task<COREAPPDATAREPOMODELSDOMAIN.MergeSellerBankAccountResponse> MergeSellerBankAccountsAsync(COREAPPDATAREPOMODELSDOMAIN.MergeSellerBankAccountRequest request);

	/// <summary>
	/// Save SellerBankAccounts
	/// </summary>
	/// <returns></returns>
	Task SaveSellerBankAccountAsync();
